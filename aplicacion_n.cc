...
ModuleInterface(aplicacion)
    // parameters:
    Parameter(tamTrama, ParType_Numeric ParType_Const)
    Parameter(direccion, ParType_Numeric ParType_Const)
    // gates:
    Gate(desde_abajo, GateDir_Input)
    Gate(hacia_abajo, GateDir_Output)
EndInterface

Register_ModuleInterface(aplicacion)

//// Sample code:
// class aplicacion : public cSimpleModule
// {
//     Module_Class_Members(aplicacion,cSimpleModule,16384)
