...
Register_ModuleInterface(intermedio)

//// Sample code:
// class intermedio : public cSimpleModule
// {
//     Module_Class_Members(intermedio,cSimpleModule,16384)
